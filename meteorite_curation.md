...
{: .warning }
Although very exciting (!), DO NOT touch the meteorite with bare hands or remove it from its original location during the identification stage.
Follow the below steps to perform identification. If after following these identification steps you are still not sure, remember that it is better to properly collect the sample and find out it’s a meteorwrong in the lab than to leave a suspect meteorite in the field.
